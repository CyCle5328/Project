                        ...
                        <div className="login_wrap">
                            <div className="id_wrap">
                                <div className="id_input_box">
                                   <input className={styles.id_input} id="email" placeholder="이메일"/>
                                </div>
                            </div>
                            <div className="pw_wrap">
                                <div className="pw_input_box">
                                    <input className={styles.pw_iput} id="pw" placeholder="비밀번호"/>
                                </div>
                            </div>
                            <div className="login_btn_wrap">
                                ...
                                <input type="button" className={styles.login_btn} id="login_btn" value="로그인"/>
                            </div>
                        </div>
                    </section>
