...
public class MemberController {
	...
	// 회원 등록!
	@PostMapping(value="api/members/join", produces="application/json; charset=UTF-8")
	...
	// 회원 로그인
	@PostMapping(value="api/members/login", produces="application/json; charset=UTF-8")
	...
	// 회원 휴대폰번호 변경
	@PutMapping(value="api/members/changeTel", produces="application/json; charset=UTF-8")
	public Map<String, Object> changeTel(@RequestBody Member member) {
		return service.changeTel(member);
	}
	
	// 회원 탈퇴
	@DeleteMapping(value="api/members/{userNo}", produces="application/json; charset=UTF-8")
	...
	// 아이디 찾기 
	@GetMapping(value = "api/members/findId/tel/{tel}", produces = "application/json; charset=UTF-8")
	public Map<String, Object> findId (@PathVariable(value = "tel") String tel){
		return service.findId(tel);
	}
	
	// 비번찾기
	@PostMapping(value = "api/members/sendAuthCode", produces = "application/json; charset=UTF-8")
